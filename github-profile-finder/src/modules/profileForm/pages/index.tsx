...
const Home = () => {
	const [user, setUser] = useState<GithubUserInterface>({
		login: 'jpcchaves',
		id: 95300143,
		...
		starred_url:
			'https://api.github.com/users/jpcchaves/starred{/owner}{/repo}',
		...
		received_events_url:
			'https://api.github.com/users/jpcchaves/received_events',
		type: 'User',
		site_admin: false,
		name: 'João Paulo',
